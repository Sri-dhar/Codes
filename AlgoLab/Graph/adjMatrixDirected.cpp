...
void printAllEdges(vector<vector<int>> adjMat)
{
    for(int i=0; i<adjMat.size(); i++)
    {
        for(int j=0; j<adjMat.size(); j++)
        {
            if(adjMat[i][j] != 0)
            {
                cout<<"The exist an edge between "<<i<<" -> "<<j<<endl;
            }
        }
    }
}
...
int main()
{
    ...
    {
        cout << "\nMain Menu:" << endl;
        cout << "1. Check if an directed edge exists" << endl;
        ...
        case 1:
            ...
            if (isEdge(a, b, adjMat))
                cout << "An directed edge exists between " << a << " and " << b << endl;
            else
                cout << "No directed edge exists between " << a << " and " << b << endl;
            break;
