...
//                 if (remainingBurst[i] > quantum)
//                 {
//                     printProcessExecution(time, time + quantum, processtable[i]);
//                     time += quantum;
//                     remainingBurst[i] -= quantum;
//                 }
//                 else
//                 {
//                     printProcessExecution(time, time + remainingBurst[i], processtable[i]);
//                     time += remainingBurst[i];
//                     processtable[i].turnaround = time - processtable[i].arrival;
//                     processtable[i].wait = processtable[i].turnaround - processtable[i].cpuburst;
//                     remainingBurst[i] = 0;
...
//     // Calculate turnaround and wait times for any remaining processes
//     for (int i = 0; i < numProcesses; i++)
//     {
//         if (remainingBurst[i] > 0)
//         {
    ...
    while (1)
    {
        ...
        for (int i = 0; i < numProcesses; i++)
        {
            if (remainingBurst[i] > 0)
            {
                ...
                {
                    int start_time = time;
                    printProcessExecution(start_time, start_time + quantum, processtable[i]);
                    time += quantum;
                    remainingBurst[i] -= quantum;
                }
                else
                {
                    int start_time = time;
                    printProcessExecution(start_time, start_time + remainingBurst[i], processtable[i]);
                    time += remainingBurst[i];
                    processtable[i].turnaround = time - processtable[i].arrival;
                    processtable[i].wait = processtable[i].turnaround - processtable[i].cpuburst;
                    remainingBurst[i] = 0;
